...
import com.calandar.price.bean.ProductDatePrice;
import com.calandar.price.utils.RandomUtils;
import com.calandar.price.utils.StringUtils;
...
public class MoreInfoCalendarActivity extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		for (ProductDatePrice productDatePrice : mDatePriceList)
		{//把价格数据改为同一个月的list 在一个key value里，减少渲染界面时循环判断数量
