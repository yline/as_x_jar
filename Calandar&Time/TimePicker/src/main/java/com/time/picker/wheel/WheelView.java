...
public class WheelView extends View
{
	...
	private static final int[] SHADOWS_COLORS = new int[]{0xFFf8f8ee,
			0x00f8f8ee, 0x00f8f8ee};
	
	/** Additional items height (is added to standard text item height) */
	public int ADDITIONAL_ITEM_HEIGHT;
	...
	private static final int DEF_VISIBLE_ITEMS = 5;//���������յ�λ��
	...
	private void initData(Context context)
	{
		...
		ADDITIONAL_ITEM_HEIGHT = dp2px(context, 25);
		TEXT_SIZE = dp2px(context, 16);
		ADDITIONAL_ITEMS_SPACE = dp2px(context, 1);
		LABEL_OFFSET = dp2px(context, 1);
	}
