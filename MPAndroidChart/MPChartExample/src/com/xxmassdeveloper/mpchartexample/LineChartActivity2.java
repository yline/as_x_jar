...
//            }
        ...
        if (mChart.getData() != null &&
            ...
            LineDataSet set2 = (LineDataSet) mChart.getData().getDataSetByIndex(1);
            LineDataSet set3 = (LineDataSet) mChart.getData().getDataSetByIndex(2);
            ...
            LineDataSet set1 = new LineDataSet(new ArrayList<Entry>(), "DataSet 1");
            ...
            // create a dataset and give it a type
            LineDataSet set2 = new LineDataSet(yVals2.subList(0, 5), "DataSet 2");
