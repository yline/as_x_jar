...
public class CollisionLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        mBallRadius = dip2px(context, DEFAULT_BALL_RADIUS);
        mWidth = dip2px(context, DEFAULT_WIDTH);
        mHeight = dip2px(context, DEFAULT_HEIGHT);
        mOvalVerticalRadius = dip2px(context, DEFAULT_OVAL_HEIGHT);
