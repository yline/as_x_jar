package com.yline.fresco.drawable;
...
public class LevelLoadingRenderer extends LoadingRenderer {
    ...
    // 半径
    private static final float DEFAULT_CENTER_RADIUS = 22.5f;
    // 宽度
    private static final float DEFAULT_STROKE_WIDTH = 4.5f;

    private static final int[] DEFAULT_LEVEL_COLORS = new int[]{Color.parseColor("#553F51B5"),
            Color.parseColor("#b13F51B5"), Color.parseColor("#ff3F51B5")};
