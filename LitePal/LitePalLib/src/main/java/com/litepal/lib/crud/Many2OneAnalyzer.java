...
class Many2OneAnalyzer extends AssociationsAnalyzer
{
	 ...
	 * {@link com.litepal.lib.crud.DataSupport#addAssociatedModelWithFK(String, long)} and
	 * {@link com.litepal.lib.crud.DataSupport#addAssociatedModelWithoutFK(String, long)} will be
	 ...
	 * and calling
	 * {@link #dealAssociatedModelOnManySide(Collection, com.litepal.lib.crud.DataSupport, com.litepal.lib.crud.DataSupport)}
	 * to set foreign key.
	 *
	 ...
	 * {@link #buildBidirectionalAssociations(com.litepal.lib.crud.DataSupport, com.litepal.lib.crud.DataSupport, com.litepal.lib.crud.model.AssociationsInfo)}
	 * to build bidirectional association if they haven't built yet. Then calls
	 * {@link #dealAssociatedModelOnOneSide(com.litepal.lib.crud.DataSupport, com.litepal.lib.crud.DataSupport)} to set
	 * foreign key.
	 *
	 * @param baseObj         The baseObj currently want to persist.
	 * @param associationInfo The associated info analyzed by
	 ...
	 * {@link com.litepal.lib.crud.DataSupport#addAssociatedModelWithFK(String, long)}.
	 *
