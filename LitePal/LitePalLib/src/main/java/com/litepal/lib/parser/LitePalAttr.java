...
public final class LitePalAttr
{
	...
	public boolean checkSelfValid()
	{
		...
		{
			if (!cases.equals(Const.LitePal.CASES_UPPER) && !cases.equals(Const.LitePal.CASES_LOWER) && !cases.equals(Const.LitePal.CASES_KEEP))
			{
