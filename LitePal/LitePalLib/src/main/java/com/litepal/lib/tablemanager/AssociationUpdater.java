...
import com.litepal.lib.tablemanager.model.AssociationsModel;
import com.litepal.lib.tablemanager.model.ColumnModel;
import com.litepal.lib.tablemanager.model.TableModel;
import com.litepal.lib.util.BaseUtility;
import com.litepal.lib.util.Const;
import com.litepal.lib.util.DBUtility;
import com.litepal.lib.util.LogUtil;
 ...
 * {@link com.litepal.lib.tablemanager.AssociationUpdater}. So this class just deal with the simple job of
...
public abstract class AssociationUpdater extends Creator
{
	...
	/**
	 * Analysis the {@link com.litepal.lib.tablemanager.model.TableModel} by the purpose of subclasses, and
	...
	/**
	 * {@link com.litepal.lib.tablemanager.AssociationUpdater} does two jobs. Removing foreign key columns
	 ...
	 * @param tableModel Use the TableModel to get table name and columns name to
	 *                   generate SQL.
	 * @param columnName The column to judge.
	 ...
	 *
	 * @param tableName The table name use to get table model from database.
	 * @return A table model object with values from database table.
	 * @throws com.litepal.lib.exceptions.DatabaseGenerateException
	 */
	 ...
	 *
	 * @param dropTableNames The names of the tables that need to drop.
	 ...
	 *
	 * @param removeColumnNames The column names that need to remove.
	 * @param tableName         The table name to remove columns from.
	 */
	 ...
	 *
	 * @param tableNames The table names need to remove from table_schema.
	 */
	 ...
	 *
	 * @param tableName The table name use to alter to temporary table.
	 ...
	 *
	 * @param removeColumnNames The column names need to remove.
	 * @param tableModel        Which contains table name use to create new table.
	 ...
	 *
	 * @param tableModel Which contains table name use to migrate data.
	 ...
	 *
	 * @param tableName The table name use to drop temporary table.
	 ...
	 *
	 * @param tableName The table name use to generate temporary table name.
	 ...
	 *
	 * @param removeColumnNames The column names need to remove.
	 * @param tableName         The table name to remove from.
	 ...
	 * only used in {@link #findForeignKeyToRemove(com.litepal.lib.tablemanager.model.TableModel)} when iterating
	 ...
	 *
	 * @param selfTableName       The table name of currently table model.
	 * @param associatedTableName The associated table name of current table model.
	...
	/**
	 * Judge if the tableName1 equals {@link com.litepal.lib.tablemanager.model.AssociationsModel#getTableName()}
	 * and tableName2 equals {@link com.litepal.lib.tablemanager.model.AssociationsModel#getAssociatedTableName()}.
	 *
	 * @param associationModel The association model to get table name and associated table
	 *                         name.
	 * @param tableName1       The table name to match table name from association model.
	 * @param tableName2       The table name to match associated table name from association
	 *                         model.
