...
public class BaseUtility
{
	 ...
	 * litepal.xml file.
	 *
	 * @param string The string want to change case.
	 ...
	 *
	 * @param string The source sentence.
	 * @param mark   The specific substring to count.
	 ...
	 *                   statement.
	 * @throws com.litepal.lib.exceptions.DataSupportException
	 */
	 ...
	 *
	 * @param fieldType Text field type.
