...
public class DeleteHandler extends DataHandler
{
	 ...
	 * already(using {@link com.litepal.lib.crud.DataSupport#isSaved()} to test), or nothing will be
	 ...
	 * {@link #analyzeAssociations(com.litepal.lib.crud.DataSupport)}. There're two parts of
