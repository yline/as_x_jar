...
public class Many2ManyAnalyzer extends AssociationsAnalyzer
{
	 ...
	 * {@link com.litepal.lib.crud.DataSupport#addAssociatedModelForJoinTable(String, long)} will be called
	...
	/**
	 * This add an empty set for {@link com.litepal.lib.crud.DataSupport#associatedModelsMapForJoinTable}.
	 ...
	 * {@link com.litepal.lib.crud.DataSupport#associatedModelsMapForJoinTable} for
	...
	/**
	 * Get the associated table name by {@link com.litepal.lib.crud.model.AssociationsInfo} after case
	 * changed.
	 *
