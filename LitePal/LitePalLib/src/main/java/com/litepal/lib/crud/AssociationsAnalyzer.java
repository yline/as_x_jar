...
abstract class AssociationsAnalyzer extends DataHandler
{
	...
	{
		return (Collection<DataSupport>) takeGetMethodValueByField(associatedModel, associationInfo.getAssociateSelfFromOtherModel());
	}
	 ...
	 * calling {@link com.litepal.lib.crud.DataSupport#addAssociatedModelWithFK(String, long)}. Or if
	...
	/**
	 * Get foreign key name by {@link com.litepal.lib.crud.model.AssociationsInfo}.
	 *
