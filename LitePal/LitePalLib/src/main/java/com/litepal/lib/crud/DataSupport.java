...
public class DataSupport
{
	 ...
	 * {@link com.litepal.lib.crud.DataSupport#find(Class, long, boolean)}.
	 *
	...
	/**
	 * It is mostly same as {@link com.litepal.lib.crud.DataSupport#find(Class, long)} but an isEager
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.litepal.lib.crud.DataSupport#findFirst(Class, boolean)}.
	 *
	 * @param modelClass Which table to query and the object type to return.
	...
	/**
	 * It is mostly same as {@link com.litepal.lib.crud.DataSupport#findFirst(Class)} but an isEager
	 * parameter. If set true the associated models will be loaded as well.
	 *
	 * @param modelClass Which table to query and the object type to return.
	 * @param isEager    True to load the associated models, false not.
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.litepal.lib.crud.DataSupport#findLast(Class, boolean)}.
	 *
	 * @param modelClass Which table to query and the object type to return.
	...
	/**
	 * It is mostly same as {@link com.litepal.lib.crud.DataSupport#findLast(Class)} but an isEager
	 * parameter. If set true the associated models will be loaded as well.
	 *
	 * @param modelClass Which table to query and the object type to return.
	 * @param isEager    True to load the associated models, false not.
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.litepal.lib.crud.DataSupport#findAll(Class, boolean, long...)}.
	 * <p/>
	 * The modelClass determines which table to query and the object type to
	 * return.
	 *
	...
	/**
	 * It is mostly same as {@link com.litepal.lib.crud.DataSupport#findAll(Class, long...)} but an
	...
	/**
	 * When updating database with {@link com.litepal.lib.crud.DataSupport#update(long)}, you must
