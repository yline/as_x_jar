...
abstract class DataHandler extends LitePalBase
{
	...
	{
		return (Collection<DataSupport>) takeGetMethodValueByField(baseObj, associationInfo.getAssociateOtherModelFromSelf());
	}
	 ...
	 * DataSupport.
	 *
	 * @param baseObj The base object model.
	 ...
	 *
	 * @param baseObj Current model to update.
	 * @param field   To judge if with default value.
