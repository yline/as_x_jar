...
public class One2OneAnalyzer extends AssociationsAnalyzer
{
	 ...
	 * {@link #bidirectionalCondition(com.litepal.lib.crud.DataSupport, com.litepal.lib.crud.DataSupport)}. If it's
	 * unidirectional association, calls
	 * {@link #unidirectionalCondition(com.litepal.lib.crud.DataSupport, com.litepal.lib.crud.DataSupport)}.
	 *
	 ...
	 * {@link com.litepal.lib.crud.DataSupport#addAssociatedModelWithFK(String, long)}. Add its' name
	 * and id to baseObj by calling
	 * {@link com.litepal.lib.crud.DataSupport#addAssociatedModelWithoutFK(String, long)}.
	 *
	 * @param baseObj         The baseObj currently want to persist.
	 * @param associatedModel The associated model of baseObj.
	 */
