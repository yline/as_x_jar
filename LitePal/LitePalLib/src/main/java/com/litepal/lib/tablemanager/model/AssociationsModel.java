...
package com.litepal.lib.tablemanager.model;
...
public class AssociationsModel
{
	 ...
	 *
	 * @param tableHoldsForeignKey The table which holds foreign key to set.
	 */
	 ...
	 *
	 * @param associationType Within {@link Const.Model#MANY_TO_ONE},
