package com.litepal.instance.test.crud.update;


import com.litepal.instance.model.Cellphone;
import com.litepal.instance.model.Classroom;
import com.litepal.instance.model.IdCard;
import com.litepal.instance.model.Product;
...
public class UpdateUsingSaveMethodTest extends LitePalTestCase
{
	...
	public void testUpdateM2MAssociations()
	{
		...
		assertTrue(t1.save());
		assertTrue(t2.save());
		assertTrue(isIntermediateDataCorrect(getTableName(s1), getTableName(t1), s1.getId(), t1.getId()));
		assertTrue(isIntermediateDataCorrect(getTableName(s2), getTableName(t1), s2.getId(), t1.getId()));
		assertTrue(isIntermediateDataCorrect(getTableName(s3), getTableName(t1), s3.getId(), t1.getId()));
		assertTrue(isIntermediateDataCorrect(getTableName(s1), getTableName(t2), s1.getId(), t2.getId()));
		assertTrue(isIntermediateDataCorrect(getTableName(s2), getTableName(t2), s2.getId(), t2.getId()));
		assertTrue(isIntermediateDataCorrect(getTableName(s3), getTableName(t2), s3.getId(), t2.getId()));
	}
	...
	public void testUpdateM2MAssociationsWithNull()
	{
		...
		assertTrue(t1.save());
		assertTrue(t2.save());
		assertFalse(isIntermediateDataCorrect(getTableName(s1), getTableName(t1), s1.getId(), t1.getId()));
		assertFalse(isIntermediateDataCorrect(getTableName(s2), getTableName(t1), s2.getId(), t1.getId()));
		assertFalse(isIntermediateDataCorrect(getTableName(s3), getTableName(t1), s3.getId(), t1.getId()));
		assertFalse(isIntermediateDataCorrect(getTableName(s1), getTableName(t2), s1.getId(), t2.getId()));
		assertFalse(isIntermediateDataCorrect(getTableName(s2), getTableName(t2), s2.getId(), t2.getId()));
		assertFalse(isIntermediateDataCorrect(getTableName(s3), getTableName(t2), s3.getId(), t2.getId()));
	}
