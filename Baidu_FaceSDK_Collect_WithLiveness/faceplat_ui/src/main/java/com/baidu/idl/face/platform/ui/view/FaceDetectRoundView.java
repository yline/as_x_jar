...
public class FaceDetectRoundView extends View {
    ...
    public FaceDetectRoundView(Context context, AttributeSet attrs) {
        ...
        float pathSpace = FaceUnitUtil.dp2px(context, PATH_SPACE);
        float pathSmallSpace = FaceUnitUtil.dp2px(context, PATH_SMALL_SPACE);
        float pathWidth = FaceUnitUtil.dp2px(context, PATH_WIDTH);
